...
features:
  ...
  - title: "Human Escalation"
    ...
    link: /drafts/hem
  - title: "Full Session Audit"
    details: "Existing audit standards do not cover the complete agent session lifecycle including partial completion, revocation state, recovery gates, and achievability. Debugging agent failures should not be reconstruction work."
    link: /drafts/gar
---
